        ...
        <div class="container">
            ...
            <div class="container-login">
                <form action="inicio_sesion_BE.php" method="POST" class="formulario__login">
                    ...
                    <input type="password" class="passwrd" id="InputPass" placeholder="Contraseña" name="password" required>
                ...
                <form action="registro_BE.php" method="POST" name="registro" class="formulario__register">
                    ...
                    <input type="password" class="passwrd" id="InputPass" placeholder="Contraseña" name="contrasena" required>
