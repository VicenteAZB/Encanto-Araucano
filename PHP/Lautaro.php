...
<body>     
      ...
      <section class="destinations">
        ...
        <hr>
        <p>Nuestra página web de turismo te ofrece cuatro categorías para explorar y disfrutar de tu visita a Lautaro: Gastronomía, Entretenimiento, Sitios Turísticos y Cultura. Cada categoría te brinda una perspectiva única de la rica experiencia que nuestra ciudad tiene para ofrecer.</p>
    ...
    <section id="entretenimiento">
        <h2>Entretenimiento en Lautaro</h2>
    ...
    <section id="sitios-turisticos">
        <h2>Sitios Turísticos en Lautaro</h2>
