...
<body>     
    ...
    <script src = "../Scripts/script.js"></script>
        ...
        <p>Conoce y descubre la belleza que ofrece Perquenco< con nuestra galeria de imagenes</p>
        <hr>
        <ul class="grid">
