...
<head>
    ...
    <link rel="stylesheet" href="../Css/Tolten.css">
    <title>Toltén</title>
...
<body>    
    ...
    <section id="gastronomia">
        <h2>Gastronomía de Toltén</h2>
    </section>

    <section id="entretenimiento">
        <h2>Entretenimiento en Toltén</h2>
    </section>

    <section id="sitios-turisticos">
        <h2>Sitios Turísticos en Toltén</h2>
    </section>

    <section id="cultura">
        <h2>Cultura de Toltén</h2>
    </section>
