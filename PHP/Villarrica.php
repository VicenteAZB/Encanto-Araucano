...
<body>     
      ...
      <section class="destinations">
        ...
        <hr>
        <p>Nuestra página web de turismo te ofrece cuatro categorías para explorar y disfrutar de tu visita a Villarrica<<: Gastronomía, Entretenimiento, Sitios Turísticos y Cultura. Cada categoría te brinda una perspectiva única de la rica experiencia que nuestra ciudad tiene para ofrecer.</p>
    ...
    <section id="gastronomia">
        <h2>Gastronomía de Villarrica<<</h2>
    ...
    <section id="entretenimiento">
        <h2>Entretenimiento en Villarrica<<</h2>
    ...
    <section id="sitios-turisticos">
        <h2>Sitios Turísticos en Villarrica<<</h2>
    ...
    <script src = "../Scripts/script.js"></script>
        ...
        <p>Conoce y descubre la belleza que ofrece Villarrica<< con nuestra galeria de imagenes</p>
        <hr>
        <ul class="grid">
